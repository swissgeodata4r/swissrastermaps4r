...
## Does this pakcage provide access to map data?
...
In order to view the available extents, call the function `show_extents()`. The 
default method is `ggplot2`.
...
Use `method = "tmap"` to show the extents in combination with other spatial data. For example, the boundary of switzerland is included in the package.
